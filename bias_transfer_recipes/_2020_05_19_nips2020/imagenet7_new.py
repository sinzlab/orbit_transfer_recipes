...
for dataset_cls in (
    ...
    for seed in (42,):
        ...
        experiments[Description(name="Noise Augmented SGD 0.001", seed=seed)] = Experiment(
        ...
        experiments[Description(name="Noise Augmented SGD 0.01", seed=seed)] = Experiment(
            dataset=dataset.ImageDatasetConfig(
                comment=dataset_cls,
                dataset_cls=dataset_cls,
                apply_data_normalization=True,
        ...
        transfer_experiments[
            Description(
                name="Noise Augmented: SGD 0.01 -> Transfer", seed=seed
            )
        ] = TransferExperiment(
            [
