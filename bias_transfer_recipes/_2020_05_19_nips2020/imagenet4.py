...
for dataset_cls in (
    ...
    for seed in (42,):
        ...
        experiments[
            Description(name="Noise Augmented SGD 0.01 + Repr Matching", seed=seed)
        ] = Experiment(
        ...
        experiments[
            Description(name="Noise Augmented SGD 0.001 + Repr Matching", seed=seed)
        ] = Experiment(
            dataset=dataset.ImageDatasetConfig(
                comment=dataset_cls,
                dataset_cls=dataset_cls,
        ...
        # experiments[
        #     Description(name="noisy SGD 0.01 + Adv Regression", seed=seed)
        # ] = Experiment(
        #     dataset=dataset.ImageDatasetConfig(
        #         comment=dataset_cls,
        #         dataset_cls=dataset_cls,
        ...
        transfer_experiments[
            Description(
                name="Noise Augmented SGD 0.01 + Repr Matching -> Transfer",
                seed=seed,
            )
        ] = TransferExperiment(
            [
        ...
        transfer_experiments[
            Description(
                name="Noise Augmented: SGD 0.001 + Repr Matching -> Transfer",
                seed=seed,
            )
        ] = TransferExperiment(
            [
        ...
        # transfer_experiments[
        #     Description(
        #         name=dataset_cls + ": Noise Augmented: SGD 0.01 + Adv Regression",
        #         seed=seed,
        #     )
        # ] = TransferExperiment(
        #     [
