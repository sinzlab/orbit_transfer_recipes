...
for dataset_cls in (
    ...
    for seed in (
        ...
        experiments[
            Description(name="CIFAR10: Noise Augmented + Repr Matching", seed=seed)
        ] = Experiment(
            dataset=dataset.ImageDatasetConfig(
                comment=dataset_cls,
                dataset_cls=dataset_cls,
            ...
            trainer=trainer.TrainerConfig(
                ...
                early_stop=False,
                patience=1000,
                comment="Noisy normal SGD + Repr Matching",
                verbose=True,
        ...
        #         experiments[
        #             Description(
        #                 name="CIFAR10: Noise Augmented + Repr Matching", seed=seed,
        #             )
        #         ],
        #         transfer,
        #     ]
        ...
        for sparsity in (
            ...
            experiments[
                ...
                trainer=trainer.TrainerConfig(
                    ...
                    optimizer_options={"lr": 0.01, "momentum": 0.9},
                    max_iter=80,
                    lr_milestones=(50, 65, 130, 145, 210, 225, 290, 305),
                    lr_decay=0.1,
                    lottery_ticket={
                        "rounds": 4,
                        "round_length": 80,
            ...
            transfer_experiments[
                Description(
                    name=dataset_cls
                    + ": Noise Augmented + Repr Matching (LT {}) -> Retrain".format(
                        sparsity
                    ),
                    seed=seed,
                )
            ...
            #     Description(
            #         name=dataset_cls
            #         + ": Clean (LT {}) -> Retrain (Noise Augmented) -> Transfer".format(
            #             sparsity
            #         ),
            #         seed=seed,
            #     )
            ...
            transfer_experiments[
                Description(
                    name=dataset_cls
                         + ": Clean (LT {}) -> Retrain (Noise Augmented)".format(
                        sparsity
                    ),
                    seed=seed,
                )
            ...
            #     Description(
            #         name=dataset_cls
            #         + ": Noise Augmented (LT {}) -> Retrain (Noise Augmented) -> Transfer".format(
            #             sparsity
            #         ),
            #         seed=seed,
            #     )
            ...
            #     Description(
            #         name=dataset_cls
            #         + ": Noise Augmented + Repr Matching (LT {}) -> Retrain (Noise Augmented) -> Transfer".format(
            #             sparsity
            #         ),
            #         seed=seed,
            #     )
            ...
            transfer_experiments[
                Description(
                    name=dataset_cls
                         + ": Noise Augmented + Repr Matching (LT {}) -> Retrain (Noise Augmented)".format(
                        sparsity
                    ),
                    seed=seed,
                )
