...
for dataset_cls in (
    ...
    for normalization in (
        ...
        experiments[
            ...
            trainer=trainer.TrainerConfig(
                comment="Noise augmented (normalization: {})".format(normalization),
                max_iter=90,
                lr_milestones=(30, 60),
                optimizer="SGD",
                optimizer_options={"lr": 0.001, "momentum": 0.9},
        ...
        #     ),
        #     trainer=trainer.TrainerConfig(
        #         comment="noisy + rep. matching (normalization: {})".format(
        #             normalization
        #         ),
        #         max_iter=90,
        #         lr_milestones=(30, 60),
        ...
        # experiments[
        #     Description(
        #         name="clean (normalization: {}, as transform)".format(normalization),
        #         seed=seed,
        #     )
        # ] = Experiment(
        #     dataset=dataset.ImageDatasetConfig(
        ...
        #     ),
        #     trainer=trainer.TrainerConfig(
        #         comment="clean (normalization: {}, as transform)".format(normalization),
        #         max_iter=90,
        #         lr_milestones=(30, 60),
        #         optimizer="SGD",
        #         optimizer_options={"lr": 0.001, "momentum": 0.9},
        ...
        # experiments[
        #     Description(
        #         name="noisy (normalization: {}, as transform)".format(normalization),
        #         seed=seed,
        #     )
        # ] = Experiment(
        #     dataset=dataset.ImageDatasetConfig(
        ...
        #         add_corrupted_test=True,
        #         download=False,
        #         apply_noise=noise_type,
        #     ),
        #     model=model.ClassificationModelConfig(
        #         comment=dataset_cls, dataset_cls=dataset_cls
        #     ),
        #     trainer=trainer.TrainerConfig(
        #         comment="noisy (normalization: {}, as transform)".format(normalization),
        #         max_iter=1,
        #         lr_milestones=(30, 60),
        #         optimizer="SGD",
        #         optimizer_options={"lr": 0.001, "momentum": 0.9},
